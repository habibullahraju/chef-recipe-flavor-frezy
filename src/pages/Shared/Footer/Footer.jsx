...
const Footer = () => {
    return (
        <div className=''>
            <footer className="footer pt-20 p-10 bg-base-200 text-base-content">
  <div>
...
Kitchen Tips</Link> 
    <Link className="link link-hover">Dinner Recipes</Link> 
    <Link className="link link-hover">
Appetizer & Snack</Link>
  </div> 
  <div>
...
<footer className="footer px-10 py-4 border-t bg-base-200 text-base-content border-base-300">
  <div className="items-center grid-flow-col">
    ...
    <p>Copyright © 2022 Flavor Frenzy, All rights reserved.  <br/>Providing reliable tech since 1992</p>
  </div> 
